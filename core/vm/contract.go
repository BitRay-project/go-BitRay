...
//
// Account references are used during BVM initialisation and
...
// Contract represents a BitRay contract in the state database. It contains
...
// NewContract returns a new contract environment for the execution of BVM.
func NewContract(caller ContractRef, object ContractRef, value *big.Int, gas uint64) *Contract {
	c := &Contract{CallerAddress: caller.Address(), caller: caller, self: object}

	if parent, ok := caller.(*Contract); ok {        ///contract implements contractRef interface
